    ...
    <div className="flex min-h-dvh flex-col items-center justify-center px-4 py-8">
      ...
      <div className="w-full max-w-md space-y-8 text-center">
        ...
        <div className="rounded-2xl border border-white/10 bg-white/5 p-8 backdrop-blur-md shadow-[0_10px_50px_-15px_rgba(0,0,0,0.5)]">
          ...
          <button
            ...
            className={cn(
              ...
              canPlay
                ? "bg-cyan-400 text-black hover:bg-cyan-300 focus:outline-none focus:ring-2 focus:ring-cyan-200"
                : "bg-white/10 text-neutral-400 cursor-not-allowed"
            )}
            onClick={() => {
              if (canPlay) router.push("/group-selection");
            }}
          >
        ...
        <p className="text-sm text-neutral-400 max-w-sm mx-auto">
          Create micro-bets with friends. Settle in stablecoins. <br />
      ...
      <div className="mt-16 w-full max-w-4xl grid gap-6 md:grid-cols-2">
        ...
        <div className="rounded-2xl border border-white/10 bg-white/5 p-6 backdrop-blur-md">
          ...
          <ul className="space-y-2 text-sm text-neutral-300">
            <li className="flex items-start gap-2"><span className="text-cyan-300 mt-1">•</span>Create or join a friend circle</li>
            <li className="flex items-start gap-2"><span className="text-cyan-300 mt-1">•</span>Post a micro-bet (e.g., "No shot Daniel survives 6th Street")</li>
            <li className="flex items-start gap-2"><span className="text-cyan-300 mt-1">•</span>Friends pick a side and stake stablecoin amounts</li>
            <li className="flex items-start gap-2"><span className="text-cyan-300 mt-1">•</span>Resolve by group vote or photo/video proof</li>
            <li className="flex items-start gap-2"><span className="text-cyan-300 mt-1">•</span>Winners auto-receive payouts</li>
          </ul>
        </div>
      </div>
